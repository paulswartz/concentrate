defmodule Concentrate.Producer.Hackney.StateMachine do
  @moduledoc """
  ...
  * `get_opts`: (optional) values to pass as options to Hackney
  """
  require Logger
  ...
  defp handle_message(machine, {:fetch, url}) do
    message =
      case :hackney.get(url, Map.to_list(machine.headers), [], machine.get_opts) do
